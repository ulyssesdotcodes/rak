...
<link rel="stylesheet" type="text/css" href="findadate.css" />
</head>
<body>
...
<div class="container">
    ...
    <div class="form"> 
    	<form id="donate_form" oninput="donation_amount.value=parseFloat(amount_range.value).toFixed(2)">
            <fieldset>
            	<div class="gender">
                	<label class="radio"> <input class="radio_buttons" type="radio" name="gender" value="Female" />Females </label>
                	<label class="radio"> <input class="radio_buttons" type="radio" name="gender" value="Male" />Males</label>
                	<label class="radio"> <input class="radio_buttons" type="radio" name="gender" value="Both" />Surprise me!</label>
                </div>
            ...
            <input class="btn btn-inverse btn-primary btn-large" id="RAK_submit" type="submit" value="Go Fish" />
        </form>
    </div>
...
<script>
	...
	$("#donate_form").submit(function(e){
		...
		do{
			...
			doneeGender = venueData.response.hereNow.items[doneeCount].user.gender;
			if(doneeId == <?php echo $user[id]; ?> || ($("input:radio[name=gender]:checked").val() == "Female" && doneeGender == "male") || ($("input:radio[name=gender]:checked").val() == "Male" && doneeGender == "female")) continue;
			var venmoId;
